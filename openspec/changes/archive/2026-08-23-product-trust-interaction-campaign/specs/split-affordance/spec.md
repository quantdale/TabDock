...
projecting the existing split relationship and presentation semantics without introducing another authority.
...
dormant, it SHALL expose resume/show split actions for the members and end
split. Actions SHALL preserve LEFT/RIGHT identity, the dormant relationship,
composite behavior, and existing split-member removal semantics.
