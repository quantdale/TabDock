...
## Purpose
Guardrails for the real-input end-to-end test harness: every injected input and window operation is identity-verified, scoped to test-owned windows, cleaned up unconditionally, and asserted to leave zero orphaned guest windows.
