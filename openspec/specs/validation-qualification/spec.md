...
- **THEN** it locates both executables, validates their candidate identities, resolves declared capabilities before destructive setup, and runs the selected catalog scenario or shard
...
- **THEN** the first valid attempt remains authoritative and a later pass after a valid failure is recorded as unresolved/flake evidence rather than PASS
