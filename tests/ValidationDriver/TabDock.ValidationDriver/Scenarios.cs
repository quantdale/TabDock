...
internal static partial class Scenarios
{
    ...
    public static readonly string[] StandaloneExtraScenarios =
    {
        ...
        "keyboard-only-tab-navigation", "crashkill-during-active-drag", "dwm-transitions-unchanged-on-capture",
        "capture-title-change-during-capture",
        "dragprobe",
...
"capture-dpi-system-guest" => CaptureDpiSystemGuest,
            ...
            "dwm-transitions-unchanged-on-capture" => DwmTransitionsUnchangedOnCapture,
            "capture-title-change-during-capture" => CaptureTitleChangeDuringCapture,
